...
pub use domain::{
    ...
    MAX_SECRET_PLACEHOLDER_BYTES, MemoryPlacement, MemorySnapshotMode, MountOptions,
    NamedVolumeCreate, NamedVolumeMode, NetworkPolicy, NetworkRateLimitDirection,
    NetworkRateLimiterConfig, NetworkSpec, NumaPlacement, OciRootfsSource, Patch, PlacementProfile,
