...
Snapshot restores show RAM-backing preparation, cache waits/reuse, syncing, and activation in the terminal. Slow preparation does not consume the activation timeout. `--quiet` hides progress; stdout remains scriptable.
