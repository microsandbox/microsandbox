...
The verb aliases `ls`, `ps`, `rm`, `cp`, and `mod` work at all three levels. Installation and self-management commands have their own sections at the end of this page.
