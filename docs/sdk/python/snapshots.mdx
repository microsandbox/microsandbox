...
await Snapshot.save("checkpoint-b", "changes.msnap", since="checkpoint-a")
await Snapshot.load("changes.msnap", base="checkpoint-a")
child = await Sandbox.create("child", from_snapshot="changes.msnap", snapshot_base="checkpoint-a")
```
