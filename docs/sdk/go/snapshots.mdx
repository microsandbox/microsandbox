...
if err != nil { return err }
err = m.Snapshot.Save(ctx, "checkpoint-b", "changes.msnap", m.SnapshotSaveOptions{Since: "checkpoint-a"})
if err != nil { return err }
snapshot, err := m.Snapshot.LoadWithBase(ctx, "changes.msnap", "", "checkpoint-a")
```
...
```go
err := m.Snapshot.Save(ctx, "after-pip-install", "/tmp/snap.msnap",
